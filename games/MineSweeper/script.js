...
function initGame(gameFormat, x, y, b) {
  gameFormat = gameFormat.toLowerCase()
      ...
      with (cellArray[arrayIndexOf(i, j)]) {
        if (!isExposed) {
          if (isBomb && !isFlagged) {
            ...
            document.images[imageIndexOf(i, j)].src =
              cellOpenIm[neighborBombs].src
          }
        }
      }
    }
...
function updateNumBombs() {
  if (!dead && !win && openRemaining && maxNumBombs - bombsFlagged == 0) {
    ...
    if (maxNumBombs < bombsFlagged) document.bomb100s.src = timeNeg.src
  }
}
...
function createBoard() {
  ...
  html +=
    '<a id="cntBombs" onclick="return bombCountClick()"><img src="images/time0.gif" border="0" name="bomb100s" width="13" height="23" alt="" /><img src="images/time0.gif" border="0" name="bomb10s" width="13" height="23" alt="" /><img src="images/time0.gif" border="0" name="bomb1s" width="13" height="23" alt="" /></a>'
  html +=
    '<a id="face" onclick="return faceClick()"><img src="images/faceclock.gif" name="face" hspace="' +
    smileMargin +
    '" border="0" width="26" height="25" alt="" /></a>'
  html +=
    '<span id="cntTime"><img src="images/time0.gif" border="0" name="time100s" width="13" height="23" alt="" /><img src="images/time0.gif" border="0" name="time10s" width="13" height="23" alt="" /><img src="images/time0.gif" border="0" name="time1s" width="13" height="23" alt="" /></span>'
  html +=
    '<img src="images/borderlr.gif" height="25" width="10" alt="" /><br />'
  ...
  for (i = 0; i <= maxY; i++) {
    ...
    html +=
      '<img src="images/borderlr.gif" border="0" height="16" width="10" alt="" /><br />'
  }
